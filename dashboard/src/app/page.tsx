    ...
    <div className="min-h-screen bg-[#050505] text-white">
      ...
      <section className="relative pt-36 pb-28 px-6 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-white/50 max-w-2xl mx-auto mb-4 leading-relaxed">
            Most job queue solutions force you to deploy and operate Redis alongside your database.
            OpenQueue runs entirely on the <span className="text-white/80">PostgreSQL you already have</span> — giving you
            reliable background jobs, automatic retries, scheduled execution, and a real-time
            dashboard without adding a single extra service.
          </p>
          ...
          <div className="mt-16 grid grid-cols-2 sm:grid-cols-4 gap-px bg-white/5 border border-white/5 rounded-2xl overflow-hidden">
            {[
              { label: "Extra infrastructure", val: "Zero", sub: "PostgreSQL only" },
              { label: "Job lease latency", val: "< 5ms", sub: "p99, under load" },
      ...
      <section className="py-24 px-6 border-t border-white/5 bg-white/[0.01]">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16">
            <p className="text-xs font-mono text-white/30 uppercase tracking-widest mb-3">The problem</p>
            <h2 className="text-3xl md:text-4xl font-bold mb-4">
              Adding a job queue shouldn&apos;t mean<br />adding a Redis operations team
            </h2>
            <p className="text-white/50 text-lg max-w-2xl mx-auto">
              Every major job queue library today assumes Redis. That means a second
              database to provision, monitor, scale, back up, and pay for — before you
          ...
          <div className="grid md:grid-cols-3 gap-5 mb-16">
            {[
              ...
              <div key={p.title} className="p-6 rounded-2xl border border-red-500/15 bg-red-500/5">
          ...
          <div className="relative p-8 rounded-2xl border border-[#00ff88]/20 bg-[#00ff88]/5 text-center overflow-hidden">
            ...
            <p className="text-sm font-mono text-[#00ff88]/70 uppercase tracking-widest mb-3">The OpenQueue approach</p>
            <p className="text-xl md:text-2xl font-semibold text-white max-w-3xl mx-auto leading-relaxed">
              ...
              <span className="text-white/50">
                Your jobs live next to your application data — queryable, observable, and
                isolated per user out of the box.
              </span>
            </p>
          </div>
        </div>
      ...
      <section id="features" className="py-24 px-6 border-t border-white/5">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <p className="text-xs font-mono text-white/30 uppercase tracking-widest mb-3">Features</p>
            <h2 className="text-3xl md:text-4xl font-bold mb-4">
              Everything you need, nothing you don&#39;t
            </h2>
            <p className="text-white/50 text-lg max-w-2xl mx-auto">
              A complete job queue system — retries, scheduling, dead-letter queues,
              multi-tenancy, and observability — all without leaving your existing
              PostgreSQL setup.
            </p>
          </div>
      ...
      <section className="py-24 px-6 border-t border-white/5 bg-white/[0.01]">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <p className="text-xs font-mono text-white/30 uppercase tracking-widest mb-3">Use cases</p>
            <h2 className="text-3xl md:text-4xl font-bold mb-4">
              What are developers building with OpenQueue?
            </h2>
            <p className="text-white/50 text-lg max-w-xl mx-auto">
              Any task that shouldn&apos;t block a web request belongs in a queue.
              Here&apos;s what teams are shipping.
            </p>
          </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {[
              ...
              >
                ...
                <p className="text-white/50 text-sm leading-relaxed mb-4">{u.body}</p>
      ...
      <section id="how-it-works" className="py-24 px-6 border-t border-white/5">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16">
            <p className="text-xs font-mono text-white/30 uppercase tracking-widest mb-3">How it works</p>
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Three API calls. That&#39;s the whole model.</h2>
            <p className="text-white/50 text-lg max-w-xl mx-auto">
            ...
            {[
              {
                ...
                detail: "Your web request returns instantly. The work happens in the background.",
              },
              {
                num: "02",
                title: "Lease & process",
                ...
                detail: "Workers can send heartbeats to extend the lease on long-running jobs.",
              },
              {
                num: "03",
                title: "Ack or nack",
                ...
                detail: "Dead jobs are visible in the dashboard and can be re-queued manually.",
              },
            ].map((s) => (
          ...
          <div className="p-6 rounded-2xl border border-white/8 bg-white/[0.03]">
            <p className="text-xs text-white/30 font-mono mb-5 uppercase tracking-widest">Job lifecycle</p>
            <div className="flex flex-wrap items-center gap-2 font-mono text-sm mb-5">
              {[
                ...
                { label: "or on failure →", color: "text-white/20", plain: true },
                { label: "pending (retry)", color: "text-yellow-400 border-yellow-400/30 bg-yellow-400/10" },
                { label: "→ … →", color: "text-white/20", plain: true },
                { label: "dead (DLQ)", color: "text-red-400 border-red-400/30 bg-red-400/10" },
              ].map((item, i) =>
                item.plain ? (
                  <span key={i} className={`text-xs ${item.color}`}>{item.label}</span>
                ) : (
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-3 text-xs text-white/40 font-mono">
              {[
                ...
                ["Visibility timeout", "Crashed workers release jobs automatically"],
                ["Heartbeat support", "Long jobs extend their own lease"],
                ["Scheduled execution", "run_at delays jobs until the right moment"],
              ].map(([title, desc]) => (
                <div key={title} className="flex flex-col gap-1 p-3 bg-white/[0.02] rounded-lg border border-white/5">
                  <span className="flex items-center gap-1 text-white/60">
                    <CheckCircle2 className="w-3 h-3 text-green-400 shrink-0" />{title}
                  </span>
      ...
      <section className="py-24 px-6 border-t border-white/5 bg-white/[0.01]">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16">
            <p className="text-xs font-mono text-white/30 uppercase tracking-widest mb-3">Comparison</p>
            <h2 className="text-3xl md:text-4xl font-bold mb-4">How OpenQueue stacks up</h2>
            <p className="text-white/50 text-lg max-w-xl mx-auto">
                ...
                <tr className="border-b border-white/10">
                  ...
                  <th className="px-5 py-4 text-center">
                    <span className="inline-flex items-center gap-1.5 text-[#00ff88] font-semibold text-sm bg-[#00ff88]/10 border border-[#00ff88]/20 px-3 py-1 rounded-full">
                      <Image src="/openqueue-logo.png" alt="OpenQueue" width={14} height={14} className="rounded-sm" /> OpenQueue
                    </span>
                  </th>
                  <th className="px-5 py-4 text-center text-white/50 font-normal text-sm">Redis / BullMQ</th>
                  <th className="px-5 py-4 text-center text-white/50 font-normal text-sm">Celery</th>
                  <th className="px-5 py-4 text-center text-white/50 font-normal text-sm">RQ</th>
                </tr>
              </thead>
              <tbody>
                {[
                  ...
                  >
                    <td className="px-6 py-3.5 text-white/70 text-sm">{row.feature}</td>
                    <td className={`px-5 py-3.5 text-center font-medium text-sm ${row.oqGreen ? "text-[#00ff88]" : row.highlight ? "text-[#00ff88] font-semibold" : "text-white/80"}`}>
                      {row.oq}
                    </td>
                    <td className="px-5 py-3.5 text-center text-white/40 text-sm">{row.bull}</td>
                    <td className="px-5 py-3.5 text-center text-white/40 text-sm">{row.celery}</td>
                    <td className="px-5 py-3.5 text-center text-white/40 text-sm">{row.rq}</td>
                  </tr>
                ))}
              </tbody>
            </table>
      ...
      <section id="code" className="py-24 px-6 border-t border-white/5">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <p className="text-xs font-mono text-white/30 uppercase tracking-widest mb-3">SDKs</p>
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Up and running in minutes</h2>
            <p className="text-white/50 text-lg max-w-xl mx-auto">
              Official clients for Python and TypeScript. Install, point at your API URL,
              and start enqueueing — no broker configuration, no connection pools to manage.
            </p>
          </div>
      ...
      <section className="py-24 px-6 border-t border-white/5">
        <div className="max-w-3xl mx-auto text-center">
          <div className="relative p-12 rounded-3xl border border-white/10 overflow-hidden">
            ...
            <p className="text-xs font-mono text-white/30 uppercase tracking-widest mb-4">Get started</p>
            <h2 className="text-3xl md:text-4xl font-bold mb-4">
              Ship your background jobs today
            </h2>
            <p className="text-white/50 text-lg mb-3 max-w-xl mx-auto">
              Sign up, get your API token, and start enqueueing jobs in under five minutes.
              No Redis. No Celery. No ops overhead.
            </p>
